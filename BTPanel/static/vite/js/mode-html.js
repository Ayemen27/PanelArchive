...
var CssHighlightRules = function () {
    ...
    this.$rules = {
        ...
        "ruleset": [{
                ...
                token: ["punctuation", "entity.other.attribute-name.pseudo-element.css?v=1758532619827"],
                regex: pseudoElements
            }, {
                token: ["punctuation", "entity.other.attribute-name.pseudo-class.css?v=1758532619827"],
                regex: pseudoClasses
            }, {
                include: "url"
            }, {
